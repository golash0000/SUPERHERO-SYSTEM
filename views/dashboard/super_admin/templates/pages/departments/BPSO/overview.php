    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="welcome-message">
                <h2 class="text-danger">Public Safety</h2>
                <p>Our safety ordinance to make our place as safe spaces in most of time.</p>
            </div>

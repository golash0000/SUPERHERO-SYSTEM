    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="welcome-message">
                <h2 class="text-danger">Children's and Women Protection</h2>
                <p>Our safety ordinance to leverage our anti abuse campaign.</p>
            </div>
            ...
            <div class="container mt-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="1">
                            <i class="fa-solid fa-person-shelter record-icon"></i>
                            <h4>Children's Rehabilitation</h4>
                            <p class="description">Click to expand more</p>
                        </div>
                    </div>
                </div>

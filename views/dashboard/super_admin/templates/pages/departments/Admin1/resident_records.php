    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="welcome-message">
                <h2 class="text-danger">Resident Records</h2>
                <p>Our record management for the residents in our barangay.</p>
            </div>
            <div class="container mt-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="4">
                            <i class="fas fa-users record-icon"></i>

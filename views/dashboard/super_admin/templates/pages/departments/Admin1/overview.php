    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="welcome-message">
                <h2 class="text-danger">E-Services for Residents Portal</h2>
                <p>Our record management to handle resident records and sorts of documents.</p>
            </div>

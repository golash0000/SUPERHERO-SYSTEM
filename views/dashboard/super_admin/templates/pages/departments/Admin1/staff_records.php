    ...
    <div id="app">
        ...
        <div class="main-content">
            <div class="welcome-message">
                <h2 class="text-danger">Staff Records</h2>
                <p>Our record management for the barangay staffs.</p>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="0">
                            ...
                            <h4>Resolution and Ordinance Records</h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="1">
                            <i class="fas fa-file-invoice-dollar record-icon"></i>
                            <h4>Tax Records</h4>
                            <p class="description">Click to learn more about this record type.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="3">
                            <i class="fas fa-heart record-icon"></i>
                            <h4>Financial Assistance for Death Burial</h4>
                            <p class="description">Click to learn more about this record type.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="record-item p-4 border rounded text-center" data-index="5">
                            <i class="fas fa-shield-alt record-icon"></i>
                            <h4>Public Safety Records</h4>
                            <p class="description">Click to learn more about this record type.</p>
                        </div>
                    </div>
                </div>
